...
import { buildPadronNameIndex, buildSharedCadastralKeys, filterReportDays, filterReportPoints, paginate, stripServicesFromDescription } from "./reportSelectors.js";
...
assert.deepEqual(buildSharedCadastralKeys([{ matches: [
  { clave_catastral: "14-28-01", abonado: "4592", nombre: "LOCAL A" },
  { clave_catastral: "14-28-01", abonado: "4468", nombre: "LOCAL B" },
