...
export default [{ ignores: ["**/node_modules/**", "**/dist/**", "bot-informes-whatsapp/**"] }, {
  ...
  languageOptions: {
    ...
    globals: Object.fromEntries(["window", "document", "navigator", "sessionStorage", "localStorage", "fetch", "console", "process", "Buffer", "URL", "URLSearchParams", "Headers", "Response", "Notification", "AbortController", "setTimeout", "clearTimeout", "setInterval", "clearInterval", "requestAnimationFrame", "cancelAnimationFrame", "performance", "ResizeObserver", "Blob", "FormData", "TextEncoder", "atob"].map((name) => [name, "readonly"]))
  },
